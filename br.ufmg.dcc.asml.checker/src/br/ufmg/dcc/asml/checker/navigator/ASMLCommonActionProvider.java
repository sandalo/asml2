package br.ufmg.dcc.asml.checker.navigator;
...
public class ASMLCommonActionProvider extends CommonActionProvider {
                ...
                WorkspaceJob job = new WorkspaceJob("refresh") { //$NON-NLS-1$
                    ...
                    public IStatus runInWorkspace(IProgressMonitor monitor) throws CoreException {
                        try {
                            ...
                            throw new CoreException(new Status(IStatus.ERROR, asmlbuilder.Activator.PLUGIN_ID, IStatus.ERROR, msg, e.getTargetException()));
    ...
    protected ImageDescriptor getImageDescriptor(String relativePath) {
        return AbstractUIPlugin.imageDescriptorFromPlugin("br.ufmg.dcc.asml.checker",relativePath);
