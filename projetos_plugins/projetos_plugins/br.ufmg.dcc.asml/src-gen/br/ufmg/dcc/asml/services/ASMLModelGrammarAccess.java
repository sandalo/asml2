...
public class ASMLModelGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class RestrictionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cComponentBComponentsBinRestrictionDeclareationParserRuleCall_4_0_0 = (RuleCall)cComponentBAssignment_4_0.eContents().get(0);
		...
		public RuleCall getComponentBComponentsBinRestrictionDeclareationParserRuleCall_4_0_0() { return cComponentBComponentsBinRestrictionDeclareationParserRuleCall_4_0_0; }
	...
	public class ComponentsBinRestrictionDeclareationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ComponentsBinRestrictionDeclareation");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cComponentBAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cComponentBAbstractComponentCrossReference_0_0 = (CrossReference)cComponentBAssignment_0.eContents().get(0);
		private final RuleCall cComponentBAbstractComponentQualifiedNameParserRuleCall_0_0_1 = (RuleCall)cComponentBAbstractComponentCrossReference_0_0.eContents().get(1);
		private final Assignment cWildcardAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cWildcardWildCardEnumRuleCall_1_0 = (RuleCall)cWildcardAssignment_1.eContents().get(0);
		...
		public Assignment getComponentBAssignment_0() { return cComponentBAssignment_0; }

		//[AbstractComponent|QualifiedName]
		public CrossReference getComponentBAbstractComponentCrossReference_0_0() { return cComponentBAbstractComponentCrossReference_0_0; }

		//QualifiedName
		public RuleCall getComponentBAbstractComponentQualifiedNameParserRuleCall_0_0_1() { return cComponentBAbstractComponentQualifiedNameParserRuleCall_0_0_1; }

		//wildcard=WildCard?
		public Assignment getWildcardAssignment_1() { return cWildcardAssignment_1; }

		//WildCard
		public RuleCall getWildcardWildCardEnumRuleCall_1_0() { return cWildcardWildCardEnumRuleCall_1_0; }
	}
	...
	public class WildCardElements extends AbstractEnumRuleElementFinder {
		...
		private final Keyword cPackageFullStopAsteriskKeyword_0_0 = (Keyword)cPackageEnumLiteralDeclaration_0.eContents().get(0);
		private final EnumLiteralDeclaration cPackageAndSubPackageEnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cPackageAndSubPackageFullStopAsteriskAsteriskKeyword_1_0 = (Keyword)cPackageAndSubPackageEnumLiteralDeclaration_1.eContents().get(0);
		
		//enum WildCard:
		//	Package=".*" | PackageAndSubPackage=".**";
		public EnumRule getRule() { return rule; }
		...
		//".*"
		public Keyword getPackageFullStopAsteriskKeyword_0_0() { return cPackageFullStopAsteriskKeyword_0_0; }

		//PackageAndSubPackage=".**"
		public EnumLiteralDeclaration getPackageAndSubPackageEnumLiteralDeclaration_1() { return cPackageAndSubPackageEnumLiteralDeclaration_1; }

		//".**"
		public Keyword getPackageAndSubPackageFullStopAsteriskAsteriskKeyword_1_0() { return cPackageAndSubPackageFullStopAsteriskAsteriskKeyword_1_0; }
	}
	...
	private final ComponentsBinRestrictionDeclareationElements pComponentsBinRestrictionDeclareation;
	...
	public ASMLModelGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pComponentsBinRestrictionDeclareation = new ComponentsBinRestrictionDeclareationElements();
	}
	...
	//ComponentsBinRestrictionDeclareation:
	//	componentB=[AbstractComponent|QualifiedName] wildcard=WildCard?;
	public ComponentsBinRestrictionDeclareationElements getComponentsBinRestrictionDeclareationAccess() {
		return pComponentsBinRestrictionDeclareation;
	}
	
	public ParserRule getComponentsBinRestrictionDeclareationRule() {
		return getComponentsBinRestrictionDeclareationAccess().getRule();
	}
