package br.mg.prodemge.prodigio.wizard.test;
...
import br.mg.prodemge.prodigio.wizard.ProjectNature;

public class ProdigioWizardTest {
    private static final String C_PRODEMGE_WORKSPACES_PRODIGIOWIZARD_TEST = "C:/Prodemge/workspaces/prodigiowizard/test";

	@SuppressWarnings("nls")
    @Test
    public void testCreateProjectWithDifferentLocationArg() throws URISyntaxException, DocumentException, CoreException {
        String workspaceFilePath = C_PRODEMGE_WORKSPACES_PRODIGIOWIZARD_TEST;
    ...
    private void assertProjectDotFileAndStructureAndNatureExist(String projectPath, String name, URI location) throws DocumentException,
            CoreException {
    /*    IProject project = ProdigioWizardHelper.createProject(name, location);
    ...
    private void assertCreateProjectWithBadNameArg(String name) {
        URI location = null;
        try {
        	ProdigioWizardHelper.createProject(name, location, "",new NullProgressMonitor());
