		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponentsBinRestrictionDeclareationAccess().getGroup(), "rule__ComponentsBinRestrictionDeclareation__Group__0");
					...
					put(grammarAccess.getComponentsBinRestrictionDeclareationAccess().getComponentBAssignment_0(), "rule__ComponentsBinRestrictionDeclareation__ComponentBAssignment_0");
					put(grammarAccess.getComponentsBinRestrictionDeclareationAccess().getWildcardAssignment_1(), "rule__ComponentsBinRestrictionDeclareation__WildcardAssignment_1");
				}
			};
		}
